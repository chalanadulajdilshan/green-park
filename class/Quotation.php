...
class Quotation
{
    ...
    public function create()
    {
        ...
        (`quotation_no`, `company_id`, `date`, `customer_id`, `department_id`, `payment_type`, `remarks`, `credit_period`, `payment_term`, `validity`, `sub_total`, `discount`, `grand_total`, `created_at`) 
        VALUES 
        ('{$this->quotation_no}', '{$this->company_id}', '{$this->date}', '{$this->customer_id}', '{$this->department_id}', '{$this->payment_type}', '{$this->remarks}', '{$this->credit_period}', '{$this->payment_term}', '{$this->validity}', '{$this->sub_total}', '{$this->discount}', '{$this->grand_total}', '{$this->created_at}')";
