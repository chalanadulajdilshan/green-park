                        ...
                        <tbody>
                            ...
                            foreach ($DAG_ITEM->getByValuesDagId($dag_id) as $key => $dag_item) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        // Prefer the single serial_number field used in the current schema.
                                        $serialDisplay = '';
                                        if (!empty($dag_item['serial_number'])) {
                                            $serialDisplay = $dag_item['serial_number'];
                                        } else {
                                            // Fallback for any legacy records that might still use serial_num1..serial_num8
                                            $serial_nums = [];
                                            ...
                                            $serialDisplay = implode(', ', array_filter($serial_nums));
                                        }
                                        echo $serialDisplay;
                                        ?>
                                    </td>
